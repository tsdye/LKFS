...
of dated features are shaded gray.  Wall building phases are from
\textcite[Fig.~7]{ladefoged08:_variab_hawaii}.  Compare the building
phases assigned walls that abut trail \emph{B} on the left and right.}
